<#
    ...
    .PARAMETER Object_To_Set
        Enter the name or names of the object types you would like to affect in comma separated list
            -   domain
            -   network
            -   folder
            -   resourcePool
    ...
    .EXAMPLE
        .\set-status-morpheus-objects.ps1 -Morpheus_URL "https://morpheus.cloud.com" -token 12345qwert -zoneID 3 -Object_To_Set network,datastore,resourcePool,folder -Untouched_Networks "Net_01","Net_03" -Untouched_Datastores "ds_01","ds_01" -Untouched_ResourcePools "RP_01","RP_03" -Untouched_Folders "Folder_1","Folder_2"
    ...
    .EXAMPLE
        ​.\set-status-morpheus-objects.ps1 -morphURL "https://morpheus.cloud.com" -token 12345qwert -zoneID 3  -Object_To_Set folder -activeFolders "Folder_1","Folder_2"

        In this example, only folders are disabled excluding Folder_1 and Folder_2

    .EXAMPLE
        ​.\set-status-morpheus-objects.ps1 -morphURL "https://morpheus.cloud.com" -token 12345qwert -zoneID 3 -Object_To_Set folder,datastore,resourcePool,network,domain -enable

        In this example ALL objects the script can enable are enabled via use of the -enable switch

    .EXAMPLE
        ​.\set-status-morpheus-objects.ps1 -morphURL "https://morpheus.cloud.com" -token 12345qwert -zoneID 3 -Object_To_Set network -Untouched_Networks net-1,net-2 -enable
