...
diskCount = configspec['customOptions']['diskCount']
...
for i in range(num_disks):
    ...
    disk_label_key = f"disk{disk_name_map[disk_number]}LabelWindows"
...
final_disk = {
    ...
    "storageType": configspec['volumes'][0]['storageType'],
    "datastoreId": "autoCluster",
    "displayOrder": displayNumber + num_disks
}

configspec['volumes'].append(final_disk)
